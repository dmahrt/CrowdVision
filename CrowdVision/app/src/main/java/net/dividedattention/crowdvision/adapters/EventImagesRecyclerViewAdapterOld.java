 ...
 */
public class EventImagesRecyclerViewAdapterOld extends FirebaseRecyclerAdapter<String,EventImagesRecyclerViewAdapterOld.EventViewHolder> {
    private Context mContext;
    private PhotoClickListener mListener;

    public EventImagesRecyclerViewAdapterOld(Class<String> modelClass, int modelLayout, Class<EventViewHolder> viewHolderClass, DatabaseReference ref, Context context, PhotoClickListener listener) {
