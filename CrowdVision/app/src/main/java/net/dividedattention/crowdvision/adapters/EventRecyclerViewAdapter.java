 ...
 */
public class EventRecyclerViewAdapter extends FirebaseRecyclerAdapter<CrowdEvent,EventRecyclerViewAdapter.EventViewHolder> {
    private Context context;

    public EventRecyclerViewAdapter(Class<CrowdEvent> modelClass, int modelLayout, Class<EventViewHolder> viewHolderClass, Firebase ref, Context context) {
