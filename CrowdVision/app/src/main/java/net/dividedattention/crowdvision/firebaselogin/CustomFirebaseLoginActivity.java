 ...
 * activity.
 */
public abstract class CustomFirebaseLoginActivity extends AppCompatActivity {

    private final String TAG = "FirebaseLoginAct";

    private Firebase.AuthStateListener mAuthStateListener;
    private AuthData mAuthData;
    private CustomFirebaseLoginDialog mDialog;
    ...
    protected void onStart() {
        ...
        mDialog = new CustomFirebaseLoginDialog();
        mDialog
                .setContext(this)
